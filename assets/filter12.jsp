  ...
  <!-- 商品圖-row1--> 
    <div>
      <img class="big-pic" src="img/product/prouduct-pic.jpg">
          <div class="row1fix">
              <a  href="Bravo dog.jsp" target="_blank"><img class="row1" src="img/product/bravo dog.JPG"></a>
              <a href="Classic Pets dog can2.jsp"><img class="row1" src="img/product/Classic Pets dog can2.JPG"></a>
          ...
          <div class="flex-container fixp1">
              ...
              <p class="cpdogcan-p2 p1">NT$570</p>
              <p class="cpdogcan-p3 p1">NT$850</p>
  ...
  <!-- 商品圖-row2-->           
      <div>
          ...
          <div class="flex-container fixp2">
              <p class="cpdogcan-p4 p2">NT$780</p>
              <p class="cpdogcan-p5 p2">NT$999</p>
              <p class="cpdogcan-p6 p2"></p>
          </div>
