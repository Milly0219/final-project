  ...
  <!-- 商品圖-row1--> 
    <div>
      <img class="big-pic" src="img/product/prouduct-pic.jpg">
          <div class="row1fix">
              <a  href="Classic Pets cat can.jsp" target="_blank"><img class="row1" src="img/product/Classic Pets cat can.JPG"></a>
              <a href="Classic Pets dog can.jsp"><img class="row1" src="img/product/Classic Pets dog can.JPG"></a>
              <a href="meo cat can.jsp"><img class="row1"  src="img/product/meo cat can.JPG"></a>
          </div>
            
          <div class="flex-container fixp1">
              <p class="cpdogcan-p p1">NT$590</p>
              <p class="cpdogcan-p2 p1">NT$850</p>
              <p class="cpdogcan-p3 p1">NT$950</p>
