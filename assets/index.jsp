...
<header>
  ...
  <!-- 商品圖-row1--> 
    <div>
      <img class="big-pic" src="img/product/prouduct-pic.jpg">
          <div class="row1fix">
              <a  href="Classic Pets dog can.jsp"><img class="row1" src="img/product/Classic Pets dog can.JPG"></a>
              <a href="FUSO Pets.jsp"><img class="row1" src="img/product/FC.JPG"></a>
              <a href="Meo meat.jsp"><img class="row1"  src="img/product/meo meat.JPG"></a>
          </div>
            
          <div class="flex-container fixp1">
              <p class="cpdogcan-p p1">NT$850</p>
              <p class="cpdogcan-p2 p1">NT$699</p>
              <p class="cpdogcan-p3 p1">NT$1270</p>
  ...
  <!-- 商品圖-row2-->           
      <div>
          <div class="row2fix">
              <a href="soon.jsp"><img class="row2" src="img/product/soon.JPG"></a>
              <a href="Bravo cat.jsp"><img class="row2" src="img/product/bravo cat.JPG"></a>
              <a href="Careline.jsp"><img class="row2" src="img/product/Careline.jpg"></a>
          </div>
            
          <div class="flex-container fixp2">
              <p class="cpdogcan-p4 p2">NT$999</p>
              <p class="cpdogcan-p5 p2">NT$1250</p>
              <p class="cpdogcan-p6 p2">NT$780</p>
          </div>
  ...
  <!-- 商品圖-row3-->           
      <div>
          ...
          <div class="row3fix">
              <a href="iq meat.jsp"><img class="row3" src="img/product/iq+ meat paste.jpg"></a>
              <a href="meo cat can.jsp"><img class="row3" src="img/product/meo cat can.JPG"></a>
              <a href="Classic Pets cat.jsp"><img class="row3"  src="img/product/Classic Pets cat.JPG"></a>
          </div>
            
          <div class="flex-container fixp3">
              <p class="cpdogcan-p7 p3">NT$159</p>
              <p class="cpdogcan-p8 p3">NT$950</p>
              <p class="cpdogcan-p9 p3">NT$530</p>
          </div>
    </div>
  ...
  <!-- 商品圖-row4-->           
          <div>
              <div class="row4fix">
              <a href="Bravo dog.jsp"><img class="row4" src="img/product/bravo dog.JPG"></a>
              <a href="Classic Pets dog can2.jsp"><img class="row4" src="img/product/Classic Pets dog can2.JPG"></a>
              <a href="Classic Pets cat can.jsp"><img class="row4" src="img/product/Classic Pets cat can.JPG"></a>
          </div>
            
          <div class="flex-container4 fixp4">
              <p class="cpdogcan-p4 p4">NT$1250</p>
              <p class="cpdogcan-p5 p4">NT$570</p>
              <p class="cpdogcan-p6 p4">NT$590</p>
          </div>
          <img class="big-pic4" src="img/product/prouduct-pic3.jpg">
    </div>
