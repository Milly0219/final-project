...
<header>
    ...
    <div>
      <img class="big-pic" src="img/product/prouduct-pic.jpg">
          <div class="row1fix">
              ...
              <a href="Bravo cat.jsp"><img class="row1" src="img/product/bravo cat.JPG"></a>
          ...
          <div class="flex-container fixp1">
              ...
              <p class="cpdogcan-p2 p1">NT$1250</p>
              <p class="cpdogcan-p3 p1">NT$699</p>
  ...
  <!-- 商品圖-row2-->           
      <div>
          <div class="row2fix">
              <a href="Classic Pets dog can2.jsp"><img class="row2" src="img/product/Classic Pets dog can2.JPG"></a>
              <a href="Classic Pets cat.jsp"><img class="row2" src="img/product/Classic Pets cat.JPG"></a>
              
          </div>
            
          <div class="flex-container fixp2">
              <p class="cpdogcan-p4 p2">NT$570</p>
              <p class="cpdogcan-p5 p2">NT$530</p>
